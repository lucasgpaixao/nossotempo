...
export function UpsellOffer({ orderId, priceCents }: Props) {
  ...
  return (
    <div className="rounded-xl border border-wine/20 bg-card p-6 text-center shadow-sm">
      <p className="text-xs uppercase tracking-[0.2em] text-wine/55">Extra</p>
      <h2 className="font-heading mt-2 text-2xl font-semibold text-wine-deep">
        Polaroids para imprimir
      </h2>
      <p className="mt-2 text-sm text-muted-foreground">
        PDF A4 com suas fotos em estilo polaroid + QR da página — para imprimir
        em casa.
      </p>
